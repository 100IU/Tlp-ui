<template>
  <div class="button">
    ...
    <ShowCode desc="使用disabled属性来定义按钮是否可用">
      <ButtonDisabled ref="code"></ButtonDisabled>
    </ShowCode>
    <div class="s0">
      <h3><a>¶</a>
        不同尺寸</h3>
      <span>Button组件提供了除默认值外的三种尺寸</span>
    </div>
    <ShowCode desc="额外的尺寸:medium、small、mini，通过设置size属性来配置它们。">
      <ButtonSize ref="code"></ButtonSize>
    </ShowCode>
  </div>
</template>
<script>
