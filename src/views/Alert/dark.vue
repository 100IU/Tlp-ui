<template>
  <div class="alert">
    <Tlp-alert title="成功提示的文案" type="success" closeText="关闭" effect="dark"></Tlp-alert>
    <Tlp-alert title="消息提示的文案" type="info" closeText="关闭" effect="dark"></Tlp-alert>
    <Tlp-alert title="警告提示的文案" type="warn" closeText="关闭" effect="dark"></Tlp-alert>
    <Tlp-alert title="成功提示的文案" type="error" closeText="关闭" effect="dark"></Tlp-alert>
  </div>
</template>
